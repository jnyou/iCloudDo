package org.jnyou.anoteinventoryservice.constant;
...
public final class NumberConstant {
    ...
    public interface Number {
        ...
        Integer CONSTANT_EIGHT = 8;
        Integer CONSTANT_NINE = 9;
        Integer CONSTANT_TEN = 10;
        Integer CONSTANT_ELEVEN = 11;
        Integer CONSTANT_TWELEV = 12;
    }
    ...
    public interface StringNumber {
        ...
        String CONSTANT_SIX = "6";
        String CONSTANT_SEVEN = "7";
        String CONSTANT_EIGHT = "8";
        String CONSTANT_NINE = "9";
        String CONSTANT_TEN = "10";
        String CONSTANT_ELEVEN = "11";
        String CONSTANT_TWELEV = "12";
    }
