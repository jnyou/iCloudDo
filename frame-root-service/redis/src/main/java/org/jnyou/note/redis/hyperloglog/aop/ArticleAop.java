package org.jnyou.note.redis.hyperloglog.aop;
...
import org.jnyou.note.redis.hyperloglog.annotation.Article;
...
public class ArticleAop {
     ...
     * 定义切入点
     */
    @Pointcut("@annotation(org.jnyou.note.redis.hyperloglog.annotation.Article)")
