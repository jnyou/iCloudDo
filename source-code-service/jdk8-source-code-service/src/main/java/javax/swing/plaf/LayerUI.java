...
/**
 * The base class for all {@link JLayer}'s UI delegates.
 * <p>
 * {@link #paint(Graphics, JComponent)} method performs the
...
public class LayerUI<V extends Component>
     ...
     * in {@link #installUI(JComponent)}
     * and set the layer event mask to {@code 0}
     * in {@link #uninstallUI(JComponent)} after that.
    ...
    /**
     * Invoked when {@link JLayer#updateUI()} is called
