...
abstract public class ServerNotActiveHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, ServerNotActive that)
  {
  ...
  public static ServerNotActive extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_exception_tc (ServerNotActiveHelper.id (), "ServerNotActive", _members0);
          __active = false;
        }
      }
    }
  ...
  public static ServerNotActive read (org.omg.CORBA.portable.InputStream istream)
  {
    ServerNotActive value = new ServerNotActive ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, ServerNotActive value)
  {
