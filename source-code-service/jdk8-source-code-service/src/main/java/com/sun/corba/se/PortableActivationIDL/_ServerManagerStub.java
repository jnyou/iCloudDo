...
public class _ServerManagerStub extends org.omg.CORBA.portable.ObjectImpl implements ServerManager
{
  ...
  public void registerORB (String serverId, String orbId, ORBProxy orb, EndPointInfo[] endPointInfo) throws ServerNotRegistered, NoSuchEndPoint, ORBAlreadyRegistered
  {
            ...
            try {
                ...
                EndpointInfoListHelper.write ($out, endPointInfo);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerNotRegistered:1.0"))
                    ...
                    throw ORBAlreadyRegisteredHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public void activate (String serverId) throws ServerAlreadyActive, ServerNotRegistered, ServerHeldDown
  {
            ...
            try {
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerAlreadyActive:1.0"))
                    throw ServerAlreadyActiveHelper.read ($in);
  ...
  public void shutdown (String serverId) throws ServerNotActive, ServerNotRegistered
  {
            ...
            try {
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerNotActive:1.0"))
                    throw ServerNotActiveHelper.read ($in);
                else if (_id.equals ("IDL:PortableActivationIDL/ServerNotRegistered:1.0"))
                    throw ServerNotRegisteredHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
  ...
  /** locate server - returns the port with a specific type for all registered
	...
	*/
  public com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerType locateServer (String serverId, String endPoint) throws NoSuchEndPoint, ServerNotRegistered, ServerHeldDown
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  /** locate server - returns all ports registered with a specified ORB for
	...
	* Starts the server if it is not already running.
	*/
  public com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB locateServerForORB (String serverId, String orbId) throws InvalidORBid, ServerNotRegistered, ServerHeldDown
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
