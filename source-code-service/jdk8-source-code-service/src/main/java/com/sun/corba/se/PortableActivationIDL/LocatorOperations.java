...
public interface LocatorOperations 
{
  ...
  /** locate server - returns the port with a specific type for all registered
	...
	*/
  com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerType locateServer (String serverId, String endPoint) throws NoSuchEndPoint, ServerNotRegistered, ServerHeldDown;

  /** locate server - returns all ports registered with a specified ORB for
	* an active server
	* Starts the server if it is not already running.
	*/
  com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB locateServerForORB (String serverId, String orbId) throws InvalidORBid, ServerNotRegistered, ServerHeldDown;
