/*
 ...
 Source Schema         : gmall_sms

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 23/02/2021 14:19:23
*/
...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品会员价格' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (1, 21, 2, '铜牌会员', 7499.0000, 1);
INSERT INTO `sms_member_price` VALUES (2, 21, 3, '银牌', 7399.0000, 1);
...
CREATE TABLE `sms_seckill_session`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '秒杀活动场次' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_seckill_session
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES (1, '2021/2/17的8点整秒杀场', '2021-02-17 00:00:00', '2021-02-17 00:10:00', 1, '2021-02-16 10:55:28');
INSERT INTO `sms_seckill_session` VALUES (2, '2021/2/17的10点整秒杀场', '2021-02-17 02:00:00', '2021-02-17 02:10:00', 1, '2021-02-16 10:56:13');
INSERT INTO `sms_seckill_session` VALUES (3, '17:00', '2021-02-17 09:00:00', '2021-02-17 11:00:00', 1, '2021-02-17 09:36:57');
INSERT INTO `sms_seckill_session` VALUES (4, '18:00', '2021-02-19 08:00:00', '2022-02-10 10:00:00', 1, '2021-02-19 10:30:45');
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_seckill_sku_relation
-- ----------------------------
INSERT INTO `sms_seckill_sku_relation` VALUES (1, NULL, 1, 7, 5999, 100, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (2, NULL, 2, 8, 6199, 50, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (3, NULL, 3, 7, 5999, 80, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (4, NULL, 3, 21, 7399, 50, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (5, NULL, 4, 7, 5999, 100, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (6, NULL, 4, 8, 6199, 50, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (7, NULL, 4, 10, 6399, 50, 1, 1);
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品满减信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (1, 21, 7000.0000, 200.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品阶梯价格' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (1, 21, 3, 0.98, NULL, 0);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品spu积分设置' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (1, 4, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (2, 5, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (3, 6, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (4, 7, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (5, 8, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (6, 9, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (7, 10, 500.0000, 500.0000, NULL);
