package org.jnyou.smsservice.utils;
...
public class SendSms {
    ...
    public static SendSmsResponse sendSms(String phone,Map<String,Object> templateParam) throws ClientException {
...
//        request.putQueryParameter("TemplateParam", "{\"code\":"+getRandNum()+"}");
     ...
     * @return
     */
    public static Map<String,Object> getRandNum() {
        // 生成4位随机值  传到ali
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        SendSmsResponse response = sendSms(phone,getRandNum());
