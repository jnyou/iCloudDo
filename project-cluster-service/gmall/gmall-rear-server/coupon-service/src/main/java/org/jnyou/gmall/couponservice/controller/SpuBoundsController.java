...
public class SpuBoundsController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("couponservice:spubounds:list")
    ...
    //@RequiresPermissions("couponservice:spubounds:info")
    ...
    //@RequiresPermissions("couponservice:spubounds:update")
    ...
    //@RequiresPermissions("couponservice:spubounds:delete")
