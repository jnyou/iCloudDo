...
//        String accessKeySecret = "gFfw1p6Eo3u7YDhPv1dFR6cNPgkjq7";
        ...
        // 引入阿里云oss组件存储：aliyun-oss-spring-boot-starter
        String bucketName = "smallsword-mall";
// <yourObjectName>上传文件到OSS时需要指定包含文件后缀在内的完整路径，例如abc/efg/123.jpg。
        String objectName = "37087592-8715-455c-AF06-F487E3731003.png";

// 创建OSSClient实例。
//        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);

// 上传文件到指定的存储空间（bucketName）并将其保存为指定的文件名称（objectName）。
        InputStream inputStream = new FileInputStream("C:\\Users\\YJN\\Pictures\\Saved Pictures\\37087592-8715-455c-AF06-F487E3731003.png");
